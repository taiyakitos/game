...
gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback17006908 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.camera.hideLayer(runtimeScene, eventsFunctionContext.getArgument("Layer"));
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__FlashLayer__FlashLayer.idToCallbackMap.set(17006908, gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback17006908);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.getArgument("Duration")), (runtimeScene) => (gdjs.evtsExt__FlashLayer__FlashLayer.asyncCallback17006908(runtimeScene, eventsFunctionContext, asyncObjectsList)), 17006908, asyncObjectsList);
}
}
